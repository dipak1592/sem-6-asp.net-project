...
(function() {
	...
	*/
	function _positionHotspots(options) {
		...
		var imageWidth = $(options.mainselector + ' ' + options.imageselector).width(); 
		var imageHeight = $(options.mainselector + ' ' + options.imageselector).height();		
